...
require (
	...
	github.com/sirosfoundation/go-trust v0.3.1-0.20260504153707-11e4e9a51cb9 // pre-release: needs testserver + action.parameters (pending v0.4.0 tag)
...
require (
	...
	github.com/sirosfoundation/g119612 v0.3.3-0.20260424115313-28620f4a80ab // indirect
