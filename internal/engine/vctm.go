...
func NewVCTMHandler(flow *Flow, cfg *config.Config, logger *zap.Logger, trustSvc *TrustService, registry *RegistryClient, verifiers storage.VerifierStore, issuers storage.IssuerStore, trustCache *TrustCache) (FlowHandler, error) {
